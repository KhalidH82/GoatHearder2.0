...
function createBoard() {
  ...
  doc.setAttribute("class", "wrapper");
...
function checkMatch2() {
  if (goatArray[0] - goatArray[1] === 15) {
    ...
    board.innerText = " Player 1 Matches: " + play1.length / 2;
...
function checkMatch3() {
  if (goatArray[0] - goatArray[1] === 15) {
    ...
    board2.innerText = " Player 2 Matches: " + play2.length / 2;

    console.log(board2);
    scoreBoard[0].appendChild(board2);
    console.log(board2);
  } else if (goatArray[0] - goatArray[1] === -15) {
    play2.push(goatArray[0]);
    play2.push(goatArray[1]);
